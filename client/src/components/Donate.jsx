...
import { FaCoffee, FaCreditCard, FaMobileAlt, FaHeart, FaGithub, FaPaypal, FaBitcoin, FaArrowRight, FaUsers, FaCode, FaRocket } from "react-icons/fa";
...
const donationTiers = [
  ...
  },
  {
    ...
    perks: ["All previous perks", "Early access to new tools", "Monthly newsletter"]
  },
  {
    amount: 50,
    ...
    perks: ["All previous perks", "Exclusive community events", "Direct feedback channel"]
  },
  {
    amount: 100,
    ...
    perks: ["All previous perks", "Your name in our hall of fame", "Priority support"]
  }
];
...
const Donate = () => {
  ...
  const handleDonate = (method, amount = null) => {
    const donationAmount = amount || customAmount || (selectedTier ? selectedTier.amount : 0);
    ...
    alert(`Thank you for choosing to donate $${donationAmount} via ${method}! Redirecting to payment...`);
  };
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Help us build a stronger open source community and create better resources for developers worldwide.
          </p>
        </div>
        ...
        {/* Donation Tiers */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold gradient-text mb-8 text-center">Choose Your Support Level</h2>
            ...
            {donationTiers.map((tier, index) => (
              <div
                ...
                className={`glass-effect rounded-2xl p-6 card-hover cursor-pointer transition-all duration-300 animate-fade-in-up ${
                  selectedTier?.amount === tier.amount ? "ring-2 ring-primary-500 shadow-2xl shadow-primary-500/25" : ""
                }`}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2 text-center">{tier.title}</h3>
                ...
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold text-primary-400 uppercase tracking-wide">Perks:</h4>
        ...
        {/* Custom Amount */}
        <div className="glass-effect rounded-2xl p-8 mb-16 animate-fade-in-up" style={{ animationDelay: '1.2s' }}>
          <h2 className="text-2xl font-bold gradient-text mb-6 text-center">Or Choose Your Own Amount</h2>
        ...
        {/* Payment Methods */}
        <div className="glass-effect rounded-2xl p-8 mb-16 animate-fade-in-up" style={{ animationDelay: '1.4s' }}>
          <h2 className="text-2xl font-bold gradient-text mb-8 text-center">Choose Payment Method</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* How Donations Help */}
        <div className="glass-effect rounded-2xl p-8 mb-16 animate-fade-in-up" style={{ animationDelay: '1.6s' }}>
          <h2 className="text-3xl font-bold gradient-text mb-8 text-center">How Your Donation Helps</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl mb-4">🚀</div>
              <h3 className="text-xl font-bold text-white mb-3">Project Development</h3>
              <p className="text-gray-300 leading-relaxed">
                Fund the development of new tools, libraries, and educational resources that benefit the entire community.
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🎓</div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Create free courses, workshops, and mentorship programs to help developers grow their skills.
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🌍</div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Organize hackathons, conferences, and meetups that bring the community together and foster collaboration.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Thank You Message */}
        <div className="text-center glass-effect rounded-2xl p-8 animate-fade-in-up" style={{ animationDelay: '1.8s' }}>
          <div className="text-6xl mb-4">☕</div>
          <h2 className="text-2xl font-bold gradient-text mb-4">Every Contribution Matters</h2>
          <p className="text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Whether you donate $5 or $500, your support makes a real difference in our ability to serve the developer community. 
            Thank you for believing in our mission and helping us build a better future for open source!
          </p>
          <div className="flex items-center justify-center mt-6 text-red-500">
            <FaHeart className="animate-pulse mr-2" />
            <span className="text-white">Made with love by the Puffadders community</span>
